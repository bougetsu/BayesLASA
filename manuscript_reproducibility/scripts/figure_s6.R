...
matplot(log(K_mat.dfr.6$beta_sigma), log2(K_mat.dfr.6[, 2:3]),
  col = c("orange", "#FC4E07"),
...
plot(log(ald.dfr$lambda), log2(ald.dfr$K),
  type = "l", col = "#00AFBB", lty = 2, # Create second plot without axes
...
matplot(log(K_mat.dfr.7$beta_sigma), log2(K_mat.dfr.7[, 2:3]),
  col = c("orange", "#FC4E07"),
...
matplot(log(K_mat.dfr.8$beta_sigma), log2(K_mat.dfr.8[, 2:3]),
  col = c("orange", "#FC4E07"),
