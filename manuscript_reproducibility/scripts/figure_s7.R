#######################################################################
##* Fig.S7 sensitivity analysis of simulated polygons
...
##* make plot
pdf(file = file.path(fig.output, paste0("figure_s7a.pdf")), width = 4.1, height = 4)
...
pdf(file = file.path(fig.output, paste0("figure_s7b.pdf")), width = 4.1, height = 4)
